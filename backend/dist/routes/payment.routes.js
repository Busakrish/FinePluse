...
router.post('/simulate', authenticate, (req, res) => {
    ...
    const { recipientUpiId, recipientName, amount, category, paymentMethod = 'UPI', notes = 'Simulated UPI Transfer', } = req.body;
    ...
    const newTx = {
        ...
        status: fraudEval.is_anomaly ? 'FLAGGED' : 'COMPLETED',
