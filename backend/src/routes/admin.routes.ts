...
router.get('/decision-stream', authenticate, requireAdmin, (req: AuthenticatedRequest, res: Response): any => {
...
router.get('/audit-logs', authenticate, requireAdmin, (req: AuthenticatedRequest, res: Response): any => {
