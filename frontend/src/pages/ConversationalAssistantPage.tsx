...
export const ConversationalAssistantPage: React.FC = () => {
  ...
  // Quick Action Exploration Pills (Fully localized based on active language)
  const quickFeaturePills =
    language === 'gu'
      ? [
          { label: '💰 મારો ખર્ચ કેવો છે?', query: 'આ મહિને મારો ખર્ચ કેવો છે? કૃપા કરીને Spending Coach રિપોર્ટ આપો.' },
          { label: '💳 મારું એકાઉન્ટ બેલેન્સ', query: 'મારું એકાઉન્ટ બેલેન્સ કેટલું છે?' },
          { label: '📅 આગામી ચૂકવણી અને EMI', query: 'આ મહિને મારી આગામી EMI અને બિલની વિગતો શું છે?' },
          { label: '📉 વધુ બચત કેવી રીતે કરવી?', query: 'હું વધુ પૈસા કેવી રીતે બચાવી શકું? બજેટિંગ સલાહ આપો.' },
          { label: '🔄 શું હું EMI ઘટાડી શકું?', query: 'શું હું મારી લોનની EMI ઘટાડી શકું અથવા પુનર્ગઠન કરી શકું?' },
          { label: '🛡️ ફ્રોડ સુરક્ષા અને કાર્ડ ફ્રીઝ', query: 'જો શંકાસ્પદ વ્યવહાર થાય તો કાર્ડ કેવી રીતે ફ્રીઝ કરવું?' },
          { label: '🎯 લાઈફ ઇવેન્ટ આગાહી', query: 'મારા માટે કઈ નાણાકીય લાઈફ ઇવેન્ટ્સ આગાહી કરવામાં આવી છે?' },
        ]
      : language === 'hi'
      ? [
          { label: '💰 मेरा खर्च कैसा चल रहा है?', query: 'इस महीने मेरा खर्च कैसा चल रहा है? मुझे AI Spending Coach रिपोर्ट दें।' },
          { label: '💳 मेरा बैंक बैलेंस', query: 'मेरा बैंक बैलेंस कितना है?' },
          { label: '📅 आगामी किश्तें व देय तिथियां', query: 'मेरी आगामी किश्तें (EMI) और देय तिथियां कब हैं?' },
          { label: '📉 अधिक बचत कैसे करें?', query: 'मैं अधिक पैसे कैसे बचा सकता हूँ? व्यावहारिक बजट सलाह दें।' },
          { label: '🔄 क्या मेरी EMI कम हो सकती है?', query: 'क्या मैं अपनी लोन EMI कम कर सकता हूँ या समाधान राहत पा सकता हूँ?' },
          { label: '🛡️ फ्रॉड सुरक्षा व कार्ड फ्रीज', query: 'आपातकाल में कार्ड या UPI कैसे ब्लॉक करें?' },
          { label: '🎯 जीवन घटना भविष्यवाणी', query: 'मेरे लिए कौन से वित्तीय माइलस्टोन या लाइफ इवेंट्स पहचाने गए हैं?' },
        ]
      : [
          { label: '💰 How Am I Spending?', query: 'How am I spending this month? Please give me an AI spending coaching report.' },
          { label: '💳 My Account Balance', query: 'What is my current available balance?' },
          { label: '📅 Upcoming Payments & EMIs', query: 'What are my upcoming payments, bills, and expected salary this month?' },
          { label: '📉 How to Save More?', query: 'How can I save more money? Give me practical budgeting advice.' },
          { label: '🔄 Can I Reduce This EMI?', query: 'Can I reduce my loan EMI or restructure it under Samadhan relief?' },
          { label: '🛡️ Fraud Security & Freeze', query: 'How can I freeze my card or report an unauthorized transaction?' },
          { label: '🎯 Detected Life Events', query: 'What life events have you detected for me and what should I prepare for next?' },
        ];
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="font-bold text-slate-900 text-xs sm:text-sm">{t('assistant_title')}</span>
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      {!isUser && m.model_used && (
                        <span
                          className={`px-1.5 py-0.5 rounded font-bold text-[10px] border flex items-center gap-1 ${
                        ...
                        >
                          ...
                          {m.model_used.includes('gemini') ? 'Gemini 3.6 Flash' : 'FinPulse Core Engine'}
                        </span>
                      )}
                      {!isUser && m.intent && (
            ...
            <div className="p-4 rounded-2xl rounded-bl-xs bg-slate-50 border border-slate-200 text-xs text-slate-600 shadow-xs space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-slate-800">
                  {language === 'gu'
                    ? 'FinPulse AI તમારા બેંક ડેટાનું વિશ્લેષણ કરી રહ્યું છે...'
                    : language === 'hi'
                    ? 'FinPulse AI आपके बैंक रिकॉर्ड का विश्लेषण कर रहा है...'
                    : 'FinPulse AI is analyzing verified banking facts...'}
                </span>
              </div>
